...
const News = () => {
    ...
    const article = history.find(item => item._id === id)
    console.log(article)
    if (!article) {
        return <div>Article not found.</div>;
    }
    const { others_info, category_id, rating, total_view, title, author, thumbnail_url, image_url, details } = article
    return (
        <div>
            <Header></Header>
            <Navbar></Navbar>
                ...
                <div className="col-span-3">
                    ...
                    <div className="flex flex-col  p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-50 dark:text-gray-800">
                        <div className="flex space-x-4">
                            <img alt="" src={thumbnail_url} className="object-cover w-12 h-12 rounded-full shadow dark:bg-gray-500" />
